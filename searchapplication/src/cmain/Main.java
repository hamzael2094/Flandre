...
import searchappli.Swingsearch;

public class Main {

	public static void main(String[] args)throws IOException  {
		
		//Swingsearch sw=new Swingsearch();
//		String Chaine = "Bonjour les GE te les GI";
//		File monfichier=new File("C:/java applications/Note.txt");//file's path
//		monfichier.createNewFile();//file's creation
//		System.out.println(monfichier.exists());
//		File f=monfichier.getParentFile();
//		System.out.println(f.toString());
//		
//		File e=new File("C:\\Users\\user\\Documents\\");
//		Exemplefile.listeFichier(e);
//
//    try {
//
//	FileInputStream ee = new FileInputStream ("C:/java applications/Note.txt") ;
//
//	byte buffer [ ] = new byte [ee.available()] ;
//
//	ee.read (buffer) ;
//
